...
| `warn-hardcoded-secrets` | file | warn | `API_KEY = "..."`, `ACCESS_KEY`, `JWT_SECRET`, `CLIENT_SECRET`, and other credential patterns in code, in snake_case or camelCase (`apiKey`, `stripeApiKey`) |
