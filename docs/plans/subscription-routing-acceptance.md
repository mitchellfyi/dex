...
| 12 | Pinning is strict and unsupported content is rejected; a smaller-context model stays selectable in a running session with each request sized to the model serving it | `scripts/ccr/policy.cjs:40`, `scripts/ccr/policy.cjs:167` | `tests/ccr-policy.test.cjs:40`, `tests/ccr-policy.test.cjs:154`, `tests/ccr-service.test.cjs:100`, `tests/ccr-runtime.test.cjs:97` | MET |
