...
- Keep failed and pending checks explicit; do not switch branches or create or update a PR" ;;
    4) scope_lines="- DO run format/lint/typecheck/test and fix failures
- This is the final PR gate, not the first opportunity to commit
- As verification repairs form natural boundaries, commit and push each coherent repair checkpoint immediately without waiting for the rest of the pipeline
