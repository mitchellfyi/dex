...
2. **/dkreview --single-pass** — run one review wave on your changes (code-change sessions only): compact context pack, deterministic checks, issue harvest, verifier triage, batch fixes, and targeted recheck
