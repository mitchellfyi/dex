...
3. **Project-specific review criteria** — `.dex/review-rules.md` (path-specific review focus) and any review-criteria sections in `.dex/dex.md`. Some projects extend or override the defaults below.
