...
- Include `Generated by Doyaken` as the final footer when the project has no stricter PR template.
...
- [ ] Attribution is Doyaken-only; no Claude Code generated-by footer or Claude co-author text
