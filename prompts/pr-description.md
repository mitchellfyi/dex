...
- Before finalizing a PR title or body, invoke the `humanizer` skill.
  Please remove all mannered prose. Preserve template headings, checkboxes,
  code blocks, commands, paths, ticket links, metrics, and the required footer
  exactly.
