...
- [ ] READY — short walkthrough prepared: `<absolute path to walkthrough.mp4>`
- Poster and local manifest: `<poster.png>` / `<visual-evidence.md>`
- [ ] SKIPPED — `<why a produced walkthrough would not improve this review>`
- [ ] N/A — `<why there is no browser UI impact>`
- Upload note: local paths do not render in GitHub; drag the MP4 and poster into the PR body or a comment.
...
- [ ] Visual Evidence records READY with handoff links, SKIPPED with a reason, or N/A with a reason
